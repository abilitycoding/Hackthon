    ...
    <Container className="dashboard-body p-0  overflow-y-scroll" fluid>
      ...
      <div className="d-flex justify-content-center">
        <div class="first-section-animation">
          ...
          />
          <img
            src="https://github.com/abilitycoding/Hackthon/assets/135714603/df82c05b-c12b-4c08-b086-a20cc6a6531e"
            alt="ultimate"
            class="tooltip-week"
          />
          ...
          />
          <img
            src="https://github.com/abilitycoding/Hackthon/assets/135714603/569ffdd3-852d-40d6-b4fb-c42c86a42c81"
            alt="ultimate"
            class="symptoms"
          />
        </div>
